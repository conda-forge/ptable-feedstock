...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/ptable-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/ptable-feedstock)
...
Once the `conda-forge` channel has been enabled, `ptable` can be installed with:

```
conda install ptable
```

It is possible to list all of the versions of `ptable` available on your platform with:
